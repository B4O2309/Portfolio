...
- **Platform:** PC`,
    ...
    media: [
      { type: "video",  url: "https://www.youtube.com/embed/jsfPKItPpy0", thumbnail: "/edenisle/InGame.jpg",          caption: "Demo â€” player movement, melee combat, animal AI, and tree chopping" },
      { type: "image",  url: "/edenisle/MainMenu.jpg",                  caption: "Main Menu" },
      { type: "image",  url: "/edenisle/CharacterSelection.jpg",        caption: "Character Selection" },
      { type: "image",  url: "/edenisle/ChoosingServer.jpg",            caption: "Choosing Server" },
      { type: "image",  url: "/edenisle/InGame.jpg",                    caption: "In-Game â€” first-person view" },
      { type: "image",  url: "/edenisle/CuttingTrees.jpg",              caption: "Cutting Trees" },
      { type: "image",  url: "/edenisle/FallenTree.jpg",                caption: "Fallen Tree" },
      { type: "image",  url: "/edenisle/PickUpFruit.jpg",               caption: "Picking Up Fruit" },
      { type: "image",  url: "/edenisle/Inventory.jpg",                 caption: "Inventory" },
      { type: "image",  url: "/edenisle/Knowledge.jpg",                 caption: "Knowledge / Codex" },
      { type: "image",  url: "/edenisle/DrivingBoat.jpg",               caption: "Driving Boat" },
      { type: "image",  url: "/edenisle/BearComing.jpg",                caption: "Bear Encounter" },
      { type: "image",  url: "/edenisle/DearRunning.jpg",               caption: "Deer Running" },
      { type: "image",  url: "/edenisle/Afternoon.jpg",                 caption: "Afternoon Lighting" },
      { type: "image",  url: "/edenisle/Night.jpg",                     caption: "Night Scene" },
      { type: "image",  url: "/edenisle/MarkerOtherPlayer.jpg",         caption: "Marker â€” Other Player" },
      { type: "image",  url: "/edenisle/Player2JoinedThe Game.jpg",     caption: "Player 2 Joined the Game" },
      { type: "image",  url: "/edenisle/Player2CuttingTree.jpg",        caption: "Player 2 Cutting Tree" },
      { type: "image",  url: "/edenisle/Player2BringLog.jpg",           caption: "Player 2 Bringing Log" },
    ] as MediaItem[],
  },
  {
    id: 2,
...
- Connected audio settings sliders to AudioSettingsManager and wired sound toggle icon states`,
    ...
    media: [
      ...
      { type: "image", url: "/cockescape/Room2.png",               caption: "Room 2 — second puzzle room with a different door layout and color combination" },
      { type: "image", url: "/cockescape/ColorMixingRecipe.png",   caption: "Color Mixing Recipe — bottom HUD showing available color chips and the mixer (color1 + color2 = result)" },
      { type: "image", url: "/cockescape/ColorPainting.png",       caption: "Color Painting — applying the mixed color to a door slot to unlock the room" },
      { type: "image", url: "/cockescape/Inspection.png",          caption: "Inspection Mode — camera moves to a close-up focus position in front of an interactable object" },
      { type: "image", url: "/cockescape/BookshelfInspection.png", caption: "Bookshelf Inspection — examining the bookshelf for paper clues hidden around the room" },
      { type: "image", url: "/cockescape/Hint.png",                caption: "Hint System — in-game hint UI revealing a clue to help solve the current puzzle" },
      { type: "image", url: "/cockescape/SettingPanel.png",        caption: "Settings Panel — master volume, music, and SFX sliders with toggle icons" },
    ] as MediaItem[],
  },
  {
    id: 7,
